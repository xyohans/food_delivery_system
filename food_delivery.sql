...
INSERT INTO `addresses` (`id`, `user_id`, `label`, `address`, `is_default`, `created_at`) VALUES
(5, 10, 'home', 'airport', 1, '2026-05-03 21:27:14');
...
(7, 1, 'BBQ Bacon Burger', 'Beef patty, crispy bacon, BBQ sauce, cheddar cheese and crispy onions', 9.49, 0),
...
INSERT INTO `orders` (`id`, `customer_id`, `chef_id`, `delivery_id`, `address_id`, `status`, `delivery_address`, `total_amount`, `notes`, `created_at`, `updated_at`) VALUES
(11, 10, 14, 13, 5, 'delivered', 'airport', 5.99, '', '2026-05-03 21:27:18', '2026-05-03 21:38:25');
...
(10, 11, 'wallet', 5.99, 'completed', '2026-05-03 21:27:18');
...
(10, 'jo', 'jo@gmail.com', '$2a$10$EaknM17F4TKyDJLSwgGpr.tkxbtKWR9NxiNRYjzTc.oPLMBd9WGYK', '0900904623', 'customer', 94.01, 1, '2026-05-03 21:19:56'),
(11, 'jo', 'jo1@gmail.com', '$2a$10$92tyPTyncZ7rCa/B2EIGFusI2dPdDDb44c4T73vhL5S0mudb/mS7S', '099', 'customer', 100.00, 1, '2026-05-03 21:20:26'),
(12, 'admin', 'admin@gmail.com', '$2a$10$eBmwsx3HMEslZL8aHM5mderWYhQE2Rboo./x96bBTnHxu8znld.L2', '', 'admin', 100.00, 1, '2026-05-03 21:24:10'),
(13, 'yonas', 'yonas@gmail.com', '$2a$10$2uKnSGqFx/hTzt.FvQMdbOj1Y6hsLgziLvqjTeLBNGL59brxOxG7K', '', 'delivery', 0.00, 1, '2026-05-03 21:25:35'),
(14, 'jo', 'jj@gmail.com', '$2a$10$Us9C2PEyGcyi2JFyBVCKbOZpevD1akoeGtw/3AWAfuc/KN5gR1ABm', '', 'chef', 0.00, 1, '2026-05-03 21:26:07');
